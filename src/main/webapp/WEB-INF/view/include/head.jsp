...
<head>
    ...
    <header class="p-3 mb-3 border-bottom" style="background-color: brown">
    <div class="container">
  ...
  text-shadow: 1px 1px 2px black, 0 0 25px blue, 0 0 5px darkblue;">Tìm kiếm</a></li>
            </ul>
            <% if (user == null) {%>
  ...
  text-shadow: 1px 1px 2px black, 0 0 25px blue, 0 0 5px darkblue">user : <%=user.name%></p>
                        </div>
                        <div class="col-md-2">
                            <div class="dropdown text-start">
